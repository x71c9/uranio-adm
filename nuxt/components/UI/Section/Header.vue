...
<div class="urn-section-header overlap-group4">
	<nuxt-link class="urn-header-logo" to="/urn-admin">
		...
		<div class="group-1 logotype">
			<div class="text-icon">
				<div class="text-2 inter-medium-white-16px">
					<span class="inter-medium-white-16px">URANIO Admin</span>
				</div>
	...
	<div class="flex-row-2">
		...
		<div class="ui-header-el ui-header-right frame-71">
			...
			<div class="overlap-group">
				...
				<div class="counter-1">
					<div class="x0-1 inter-normal-white-10px">
						<span class="inter-normal-white-10px">2</span>
					</div>
				</div>
			</div>
			...
			<div class="frame-7-1">
				...
				<img class="arrowdropdown-1" src="/img/icons/@2x/arrow-drop-down-18@2x.png">
			</div>
		</div>
	</div>
</div>
