...
exports.default = {
    ...
    telemetry: false,
    alias: {
        'uranio/client': (0, path_1.resolve)(__dirname, '../client'),
        'uranio-trx/client': (0, path_1.resolve)(__dirname, '../../node_modules/uranio-trx/dist/client'),
        'uranio-trx/client/types': (0, path_1.resolve)(__dirname, '../../node_modules/uranio-trx/dist/client/types'),
        'uranio-api/client': (0, path_1.resolve)(__dirname, '../../node_modules/uranio-api/dist/client'),
        'uranio-api/client/types': (0, path_1.resolve)(__dirname, '../../node_modules/uranio-api/dist/client/types'),
        'uranio-core/client': (0, path_1.resolve)(__dirname, '../../node_modules/uranio-core/dist/client'),
        'uranio-core/client/types': (0, path_1.resolve)(__dirname, '../../node_modules/uranio-core/dist/client/types'),
    ...
    srcDir: (0, path_1.resolve)(__dirname, '../nuxt/'),
    target: 'static',
    ssr: false,
    generate: {
        dir: (0, path_1.resolve)(__dirname, '../../dist/admin'),
        fallback: '404.html',
        subFolders: false,
        exclude: ['/urn-admin'],
    },
